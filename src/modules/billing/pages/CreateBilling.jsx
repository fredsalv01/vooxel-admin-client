...
import { CardBase, DatePickerBase, InputBase, SelectBase } from '../../../components/base';
                ...
                {({ isSubmitting }) => (
                    <Form>
                        <div className="grid md:grid-cols-2 grid-cols-1">
                            <section className='grid md:grid-cols-2 grid-cols-1 gap-4 md:border-r-2 border-0 border-green-500 pr-4'>
                                <Field
                                    name="document_type"
                                    label="Tipo de doc."
                            ...
                            <section className='grid md:grid-cols-2 grid-cols-1 gap-4 pl-4'>
                                <Field
                                    name="start_date"
                                ...
                                <Field
                                    ...
                                    label="Moneda"
                                    component={SelectBase}
                                    options={[{ label: 'Soles', value: 'PEN' }, { label: 'Dólares', value: 'USD' }]}
                                />
