...
export const VacationDetail = ({ row, indexRow, onChangeForm, onDeleteRow, form }) => {
    ...
    const days = useMemo(() => {
        ...
        if (item.startDate !== row.startDate && item.endDate !== row.endDate && !settingDays) {
    ...
    return (
        <div className='grid grid-cols-1 md:grid-cols-10 gap-4 border-t border-b py-2 border-gray-400'>

            <div className='col-span-1 flex items-center justify-center'>{indexRow + 1}</div>
