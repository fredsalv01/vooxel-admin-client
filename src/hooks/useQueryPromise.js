...
export const useQueryPromise = ({ url, key }) => {
    ...
    const { data, isFetching, refetch, isSuccess, error } = useQuery({
        queryKey: [key, paginationProps.currentPage, paginationProps.itemsPerPage, debouncedSearch],
        queryFn: async () => {
    ...
    return { data, isFetching, refetch, isSuccess, error,
        paginationProps, updatingList, setQuerSearch
    };
};
